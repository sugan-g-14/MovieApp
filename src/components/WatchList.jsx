...
useEffect(()=>{
  ...
  return (
    ...
    {genreList.map((genre)=>{
       return <div onClick={()=>handleFilter(genre)} className={currGenre==genre?"flex justify-center items-center h-[3rem] w-[9rem] rounded-xl bg-blue-400 text-white font-bold mx-4":'flex justify-center items-center h-[3rem] w-[9rem] rounded-xl bg-gray-400 text-white font-bold mx-4' } >{genre}</div>
      })}
